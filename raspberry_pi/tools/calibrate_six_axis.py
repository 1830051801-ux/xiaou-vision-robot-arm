...
def main() -> int:
    ...
    record = {
        ...
        "mcu_calibration": {
            ...
            "record_version": None,
            "record_crc32": None,
            "status": "Pi draft only; F407 owns raw zero offsets and direction signs",
        },
        "zero_pose_reference_rad": _six(args.zero_offset_rad, float, "zero-offset-rad"),
        "encoder_direction_observation": directions,
